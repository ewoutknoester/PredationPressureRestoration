...
## FACFISH - BITEMARKS
FF.BM <- ggplot(Cor.fig, aes(x = Facfish.kgha, y = Bitemarks.m2, fill = Species)) + 
  ...
  geom_point(aes(fill=Species), colour = "black", shape = 21, size =3, stroke = 1.25) +
...
## BITEMARKS - CONDITION
BM.C <- ggplot(Cor.fig, aes(x = Bitemarks.m2, y = Condition, fill = Species)) + 
